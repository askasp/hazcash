defmodule HazCashWeb.Admin.SessionController do
  use HazCashWeb, :controller

  import HazCash.Admins.GenerateAdmin
  alias HazCash.{Admins, Admins.Guardian}

  plug HazCashWeb.Plugs.RedirectAdmin when action in [:new, :create]
