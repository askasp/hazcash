defmodule HazCashWeb.StripeWebhookController do
  @moduledoc """
  ...
  def notify_subscribers(event) do
    Phoenix.PubSub.broadcast(HazCash.PubSub, "webhook_received", %{event: event})
  end

  def subscribe_on_webhook_recieved do
    Phoenix.PubSub.subscribe(HazCash.PubSub, "webhook_received")
  end
