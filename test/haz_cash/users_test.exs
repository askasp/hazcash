defmodule HazCash.UsersTest do
  use HazCash.DataCase

  alias HazCash.Users

  import HazCash.UsersFixtures
  alias HazCash.Users.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "enqueues create customer worker" do
      ...
      assert_enqueued worker: HazCash.Billing.CreateCustomerWorker, args: %{id: user.id}
    end
    test "creates the personal account" do
      ...
      assert %HazCash.Accounts.Account{personal: true} = user.personal_account
      assert [%HazCash.Accounts.Membership{role: :owner, billing_customer: true}] = user.memberships
    end
  end
