defmodule HazCashWeb.UserAuthTest do
  ...
  @remember_me_cookie "_haz_cash_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HazCashWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HazCashWeb.Endpoint.subscribe(live_socket_id)
