defmodule HazCashWeb.TransferLiveTest do
  use HazCashWeb.ConnCase

  import Phoenix.LiveViewTest
  import HazCash.CoreFixtures

  @create_attrs %{actual_month: "some actual_month", actual_year: "some actual_year", description: "some description", expected_month: "some expected_month", expected_year: "some expected_year", from: %{}, labels: [], status: :confirmed, to: %{}, type: :expense}
  ...
  @invalid_attrs %{actual_month: nil, actual_year: nil, description: nil, expected_month: nil, expected_year: nil, from: nil, labels: [], status: nil, to: nil, type: nil}
  ...
  describe "Index" do
    ...
    test "lists all transfers", %{conn: conn, transfer: transfer} do
      ...
      assert html =~ transfer.actual_month
    end
    ...
    test "updates transfer in listing", %{conn: conn, transfer: transfer} do
      ...
      assert html =~ "some updated actual_month"
    end
